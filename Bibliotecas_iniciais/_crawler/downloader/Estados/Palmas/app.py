...
class Bot:
    def __init__(self) -> None:
        ...
        "download.default_directory": r'C:\clipping\crawler\selenium\Palmas', #Change default directory for downloads
        ...
        self.driver.get("http://diariooficial.palmas.to.gov.br/")
        self.driver.get_screenshot_as_file('screenshot.png')
        diario = self.driver.find_element(By.CLASS_NAME, "efeito_ultimo_diario")
        sleep(3)
        diario.click()
