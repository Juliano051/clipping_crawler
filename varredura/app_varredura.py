...
# base de dados do sistema. De posse dessa lista de dados, o script varre todos os documentos PDF e 
# busca todas as palavras-chave naquele documento. 
# Identificando, o script salva o nome do documento associado aos termos encontrados e suas respectativas páginas.
    ...
    for keyword in keywords_separate:
        ...
        for page in range(0, num_pages):
            ...
            for key in keyword_search:
                c+=1
            if c>=1:
                #keys[keywords].append(c)
                keys[keyword].append(page)
    if len(keys)>0:
